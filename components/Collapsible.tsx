      ...
      >
        <summary className="flex cursor-pointer list-none items-center justify-between gap-4">
          <span className="block">
            ...
            {/* Real heading for the section (a11y/landmarks); the <summary> still
                drives the click-to-expand, so visuals and toggle are unchanged. */}
            <h2 className="mt-1 block text-xl font-bold tracking-tight text-brand-900 font-display sm:text-2xl">{title}</h2>
          </span>
