        ...
        >
            ...
            {industries.map((v) => (
              <li key={v.slug}>
                <Link
                  ...
                  className="block rounded-lg px-3 py-2.5 text-sm text-slate-700 transition hover:bg-brand-50 hover:text-brand-900"
                >
                  {v.title}
                </Link>
              </li>
          ...
          <div className="mt-1 border-t border-slate-100 pt-1">
            <Link
              ...
              className="block rounded-lg px-3 py-2.5 text-sm font-semibold text-accent-700 transition hover:bg-accent-50"
            >
