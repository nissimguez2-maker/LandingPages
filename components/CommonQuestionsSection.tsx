...
/**
 * "Questions owners like you ask", trade-specific Q&A. Kept separate from the
 * legal FAQ and OUT of FAQ JSON-LD. Native <details>, works without JS.
 */
export default function CommonQuestionsSection({ vertical }: { vertical: VerticalConfig }) {
  const items = vertical.commonQuestions;
